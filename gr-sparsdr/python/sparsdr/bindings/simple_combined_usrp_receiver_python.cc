...
/* BINDTOOL_HEADER_FILE_HASH(62be789a21737a70738a205fceda3146)                     */
/***********************************************************************************/
...
void bind_simple_combined_usrp_receiver(py::module& m)
{
    ...
    py::class_<simple_combined_usrp_receiver,
               gr::block,
               gr::basic_block,
               std::shared_ptr<simple_combined_usrp_receiver>>(
        m, "simple_combined_usrp_receiver", D(simple_combined_usrp_receiver))
